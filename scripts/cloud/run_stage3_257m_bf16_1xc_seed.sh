...
readonly results_dir=/home/jovyan/dimativator/stage3_257m_bf16_1xc_seeds_20260923
readonly eval_cache_dir=/home/jovyan/evals_cache
readonly group=1xChinchilla_257M_bf16_native_states_seed_sweep
readonly experiment="257m_${OPTIMIZER}_bf16_1xC_seed${SEED}_cloud_1gpu"
...
echo "SEED_RUN_START optimizer=${OPTIMIZER} seed=${SEED}"
...
torchrun --standalone --nproc_per_node=1 src/main.py \
    ...
    --wandb-tags bf16_model native_optimizer_states no_fp8_optim 257M \
        "${OPTIMIZER}" full_1xc "seed_${SEED}" cloudru 1gpu local_offline

echo "SEED_RUN_COMPLETE optimizer=${OPTIMIZER} seed=${SEED} iter=39250"
